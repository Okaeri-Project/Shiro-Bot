...
if ENV:
    ...
    from Shirobot.config import Development as Config
...
telethn = TelegramClient("Shiro", API_ID, API_HASH)
pbot = Client("Shirobot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
