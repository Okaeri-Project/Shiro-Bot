...
from Shirobot import MONGO_DB_URI
from Shirobot import telethn
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"Shirobot/modules/{shortname}.py")
        name = "Shirobot.modules.{}".format(shortname)
