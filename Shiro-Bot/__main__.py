...
PM_START_TEXT = f"""
This is {BOT_NAME}[.]({SHIRO_START_IMG})
...
buttons = [
    ...
    [
        InlineKeyboardButton(
          text="📮 Updates", url="https://t.me/Shirosupportgroup"
        ),
    ],
...
HELP_STRINGS = f"""
`Hey there! My name is` [{BOT_NAME}]({SHIRO_HELP_IMG}) 
        ...
        update.effective_message.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  ...
                  [
                  InlineKeyboardButton(text="Sᴏᴜʀᴄᴇ", url="https://github.com/Wahyu213/Shiro-Bot")
                  ]
                ]
            ),
        )
    ...
    if chat.type != chat.PRIVATE:
        ...
        send_help(
            ...
            InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Back", callback_data="help_back"),
                                InlineKeyboardButton(
                                    text="Support", url="https://telegram.dog/Shirosupportgroup"
                                )]]
            ),
        )
